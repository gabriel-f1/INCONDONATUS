...
Método 1 (Recomendado): Clique duas vezes no arquivo INCONDONATUS.jar
...
Barra de Espaço: Dash (atravessar blocos especiais)

Tecla B: Atirar (apenas na fase do chefão)
...
Tente executar pelo terminal: java -jar INCONDONATUS.jar

Se o jogo travar ou fechar inesperadamente:

Certifique-se de que seu Java está atualizado
